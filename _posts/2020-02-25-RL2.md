...
called the **language accepted by $$M$$**, and denoted as $$L(M)$$. Below Figure 1 shows a DFA that accepts the language $$L = \{ ab \}$$.


<p style="text-align: center">
<img src="/assets/dfa1.png?raw=true" alt="" />
</p>
<p style="text-align: center">Figure 1: A DFA that accepts L = {ab}</p>
