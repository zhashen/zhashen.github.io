...
This is characterized by a notion called VC-dimension. In the next post, I will introduce the concept of VC-dimension and demonstrate the proof that PAC-learnability implies finite VC-dimension.